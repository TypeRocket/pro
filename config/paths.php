...
return [
    ...
    */
    ...
    |
    */
    'pages' => TR_ALT_PATH . '/resources/pages',
    ...
    |
    */
    'visuals' => TR_ALT_PATH . '/resources/visuals',
    ...
    |
    */
    'components' => TR_ALT_PATH . '/resources/components',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The PATH where TypeRocket theme and build assets are found.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The PATH where TypeRocket root are found.
    |
    */
    'base' => TR_PATH,
];
